...
public class Analyser {
	...
	private Set analiseAbstractMethods() throws ClassNotFoundException {
		...
		while (i.hasNext()) {
			...
			JavaClass[] classes = repository.findClass(baseClass.getName()).getSuperClasses();
			overridedMethods.addAll(this.getOverridedMethods(baseClass, classes));
			classes = repository.findClass(baseClass.getName()).getAllInterfaces();
			overridedMethods.addAll(this.getOverridedMethods(baseClass, classes));
		}
	 ...
	 *  
	 */
	public Set getOverridedMethods(Class baseClass, JavaClass[] classes) {
		Set overridedMethods= new HashSet();
